...
public class RedeemPoint {
  ...
  public RedeemPoint(ClientRepository clientRepository,
  ...
  private Client update(Client client, Long points) {
    final Event event = new Event(client.getId(), client.getTotalPoints(), points, "REDEEM");
    client.subtract(points);
